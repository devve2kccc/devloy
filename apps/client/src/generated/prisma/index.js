...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/alvarofernandes/Documents/dev/devloy/apps/client/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/alvarofernandes/Documents/dev/devloy/packages/db/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../../apps/client/src/generated/prisma",
    "../apps/client/src/generated/prisma",
  ]
...
path.join(process.cwd(), "../../apps/client/src/generated/prisma/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../apps/client/src/generated/prisma/schema.prisma")
